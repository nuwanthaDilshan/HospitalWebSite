...
if (isset($_POST['search'])) {
  ...
  $query = "SELECT * FROM `doctor` WHERE CONCAT(`Id`, `Name`) LIKE '%" . $valueToSearch . "%'";
            ...
            <div class="row g-0">
              <div class="col-md-3 col-lg-12 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form class="mx-2 my-auto w-100" action="adminDoctorView.php" method="post">
                    ...
                    <table>
                      ...
                      <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                        <tr>
                          ...
                          <td><?php echo $row['AppointmentDay']; ?></td>
                  ...
                  <br>
                  <br>
                      <a href="manageDoctorDetail.php" class="nav-link btn-lg text-center" style="color: #55acee;"><i class="fas fa-hand-point-left" style="color: #55acee;"></i> <span>Back</span></a>
