            ...
            <div class="row g-0">
              <div class="col-md-3 col-lg-12 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form class="mx-2 my-auto w-100" action="doctor.php" method="post">
                  ...
                  <br>
                  <br>
                      <a href="doctorLogin.html" class="nav-link btn-lg text-center" style="color: #55acee;"><i class="fas fa-hand-point-left" style="color: #55acee;"></i> <span>Back</span></a>
