...
if (isset($_POST['Update'])) {
  ...
  $query = "UPDATE `Doctor` SET Name='$_POST[Name]', AppointmentDay='$_POST[AppointmentDay]', AppointmentTime='$_POST[AppointmentTime]', EmailAddress='$_POST[EmailAddress]' , Password='$_POST[Password]' where Id='$_POST[Id]'";
  $query_run = mysqli_query($connection, $query);

  if ($query_run) {
    header('Location: manageDoctorDetail.php');
  } else {
...
if (isset($_POST['Delete'])) {
  ...
  $query = "DELETE FROM `Doctor` WHERE Id='$Id' || EmailAddress='$EmailAddress' ";
  $query_run = mysqli_query($connection, $query);
...
if (isset($_POST['Add'])) {
  ...
  $query = "INSERT INTO `Doctor`(`Id`, `Name`, `AppointmentDay`, `AppointmentTime`, `EmailAddress`, `Password`) VALUES ('$Id','$Name','$AppointmentDay','$AppointmentTime','$EmailAddress','$Password')";
  $query_run = mysqli_query($connection, $query);
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  <form action="" method="POST">
                    ...
                    <div class="form-outline mb-4">
                      <input type="text" name="Id" id="form2Example17" class="form-control form-control-lg" placeholder="Enter Id" />
                      <label class="form-label" for="form2Example17">Id</label>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="text" name="Name" id="form2Example17" class="form-control form-control-lg" placeholder="Enter Doctor Name" />
                      <label class="form-label" for="form2Example17">Name</label>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="text" name="AppointmentDay" id="form2Example17" class="form-control form-control-lg" placeholder="Enter Appointment Day" />
                      <label class="form-label" for="form2Example17">Appointment Day</label>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="text" name="AppointmentTime" id="form2Example17" class="form-control form-control-lg" placeholder="Enter Appointment Time (00:00:00)" />
                      <label class="form-label" for="form2Example17">Appointment Time</label>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="email" name="EmailAddress" id="form2Example27" class="form-control form-control-lg" placeholder=" Enter Email Address" />
                    ...
                    <div class="pt-1 mb-3 text-center">
                      ...
                      <a href="adminDoctorView.php" class="btn btn-info pr-5 pl-5" name="View">
                          View
                        </a>
                      <br />
