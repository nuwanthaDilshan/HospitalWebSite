...
if (isset($_POST['Update'])) {
  ...
  $query = "UPDATE `appointment` SET PatientName='$_POST[PatientName]',Doctor='$_POST[Doctor]' where PatientMobileNumber='$_POST[PatientMobileNumber]'";
  $query_run = mysqli_query($connection,$query);

  if($query_run){
    header('Location: manageAppointmentDetail.php');
  }
  else{
...
if(isset($_POST['Delete'])){
  ...
  $query = "DELETE FROM `appointment` WHERE PatientName='$PatientName' && PatientMobileNumber='$PatientMobileNumber' ";
  $query_run = mysqli_query($connection,$query);
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link text-info font-weight-bold" href="index.html"
          ...
          <li class="nav-item" style="color: Warning">
            <a
              class="nav-link btn btn-info pl-4 pr-4 btn-sm"
              href="register.html"
              >Join</a
            >
          </li>
                  ...
                  <div class="card-body p-4 p-lg-5 text-black">
                    <form action="" method="POST">
                      ...
                      <div class="pt-1 mb-3 text-center">
                        ...
                        <a href="adminAppointmentView.php" class="btn btn-info pr-5 pl-5" name="View">
                          View
                        </a>
