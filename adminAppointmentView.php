...
if (isset($_POST['search'])) {
  $valueToSearch = $_POST['searchName'];
  // search in all table columns
  // using concat mysql function
  $query = "SELECT * FROM `appointment` WHERE CONCAT(`PatientName`, `PatientMobileNumber`) LIKE '%" . $valueToSearch . "%'";
            ...
            <div class="row g-0">
              <div class="col-md-3 col-lg-12 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form class="mx-2 my-auto w-100" action="adminAppointmentView.php" method="post">
                  <input class="form-control mr-sm-2 my-1" type="text" name="searchName" placeholder=" Search Name">
                    ...
                    <table>
                      ...
                      <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                        <tr>
                          ...
                          <td><?php echo $row['PatientMobileNumber']; ?></td>
                  ...
                  <br>
                  <br>
                      <a href="manageAppointmentDetail.php" class="nav-link btn-lg text-center" style="color: #55acee;"><i class="fas fa-hand-point-left" style="color: #55acee;"></i> <span>Back</span></a>
